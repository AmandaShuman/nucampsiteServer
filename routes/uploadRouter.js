...
.post(authenticate.verifyUser, authenticate.verifyAdmin, upload.single('imageFile'), (req, res) => { //expecting single upload of a file whose input name is imageFile - multer takes care of everything else
  res.statusCode = 200;
